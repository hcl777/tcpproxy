...
public:
	...
	virtual int set_bandwidth(int size){return 0;}
	//virtual int set_sndbuf(int bufsize){return 0;}
	virtual int set_recvbuf(int size){return 0;}
	virtual UAC_sendspeed_t& get_sendspeed()=0;
	virtual UAC_recvspeed_t& get_recvspeed()=0;
protected:
	virtual void reset()
	{
		m_state = DISCONNECTED;
