...
#ifdef _WIN32
unsigned long long uac_GetUTickCount()
{
	static bool b=false;
...
unsigned long long uac_GetUTickCount()
{
    ...
    return (unsigned long long)(ts.tv_sec * (unsigned long long)1000000 + ts.tv_nsec / 1000);  
}
...
//			//printf("uptime=%d / %.3f \n",g_uptime,(double)uac_GetUTickCount()/1000000); 
//            alarm(1);
//            break;
//        default:
//            break;
...
//inline unsigned int uac_get_uptime()
//{
...
//}
//
//inline void uac_set_uptime(unsigned int a)
//{
//}
//
//unsigned long long uac_GetUTickCount()
...
//	uptime = uac_get_uptime();
//	tmp = sec>uptime?(sec-uptime):(uptime-sec);
//	if(tmp>2)
//	{
//		printf("#****** uac: time of day changed (%d s) \n",(int)tmp);
